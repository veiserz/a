package com.hashaan.foody.Adapter
...
import com.hashaan.foody.Database.RestaurantEntity
import com.hashaan.foody.fragment.RestaurantFragment
import com.hashaan.foody.model.Restaurants
...
class  AllRestaurantsAdapter(private var restaurants: ArrayList<Restaurants>, val context: Context) :
    ...
    override fun onBindViewHolder(p0: AllRestaurantsViewHolder, p1: Int) {
        ...
        Picasso.get().load(resObject.imageUrl).error(R.drawable.reslogo).into(p0.resThumbnail)
